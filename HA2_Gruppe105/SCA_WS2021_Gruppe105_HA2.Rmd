...
*SPALTE UMBENENNEN*
```{r}
# (1) Datenbereinigen: Nur Produkt der Gruppe105 in der Region Shanghai 
...
# Spaltennam aendern
colnames(fcast1_Shanghai) = c("Demand Forecast")

# 3 Monate bzw. ein Quartal anzeigen
head(fcast1_Shanghai, 3)[1]

# dividert durch drei, da fuer jedes supermarkt
```
