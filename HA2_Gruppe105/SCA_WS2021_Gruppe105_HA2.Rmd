...
(ets_shangh$x - ets_shangh$fitted) %>% as.numeric(.) %>% mean(.)
# MAE
(fcast_Tr$x - fcast_Tr$fitted) %>% as.numeric(.) %>% abs(.)  %>% mean(.)
# MSE
(fcast_Tr$x - fcast_Tr$fitted)^2 %>% as.numeric(.) %>% mean(.)
# MAPE
(((fcast_Tr$x - fcast_Tr$fitted)/ as.numeric(fcast_Tr$x)) * 100) %>% as.numeric(.) %>% abs(.)  %>% mean(.)
```
