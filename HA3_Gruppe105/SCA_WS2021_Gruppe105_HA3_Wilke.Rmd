...
*Zweiter Corr-Plot Vorschlag*
Quelle: https://rpubs.com/melike/corrplot
```{r}
library(corrplot)

# Matrix festlegen
M <- cps_wh_externals[, c("AvgHealth", "InternetStability", "BusinessConfidence", "ParkingSpaceAvailability", "Congestion")]


# CorrPlot gestalten
corrplot(corr_matrix, title = "Correlation Plot", method = "color", 
         outline = T, addgrid.col = "darkgray", 
         order="hclust", 
         addrect = 5,        # Nummer der Rechtecke, wir haben 5 ext Faktoren
         rect.col = "black", # rectangles (Rechtecke Farbe)
         rect.lwd = 3,       # Groeße der Rechtecke
         cl.pos = "r",          # ColourLegend Position (b = below, r = right)
         tl.col = "indianred4", # Farbe fuer Achsenbeschriftung
         
# Text: tl (TextLabel), cl (ColourLegend)
tl.cex = 0.4, cl.cex = 0.4, addCoef.col = "white", 

# Zahlen: Nachkommastelle und Groeße
