...
# R^2 und adhjusted R^2 berechnen
model_1 = lm(IFR ~ Periode, data = cps_wh_externals)
evaluation[evaluation$Model == "Baseline",]$R = summary(model_1)$r.squared
evaluation[evaluation$Model == "Baseline",]$adjR =summary(model_1)$adj.r.squared
