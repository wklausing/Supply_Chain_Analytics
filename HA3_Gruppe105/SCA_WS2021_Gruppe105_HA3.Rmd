...
ggplot(data = NULL, aes(x = m1_1_4$model$ParkingSpaceAvailability, y = m1_1_4$residuals)) + 
  geom_point() + 
  geom_smooth(se = FALSE, method = loess) + 
  ggtitle("Plot m1_1_4") +
  xlab("IFR") + ylab("Residuals")
...
```{r}
# Wir nehmen das beste Modell m1_1_4 und erstellen ein Residuenplot
ggplot(data = NULL, aes(x = m1_1_4_2$model$InternetStability, y = m1_1_4_2$residuals)) + 
  geom_point() + 
  geom_smooth(se = FALSE, method = loess) + 
...
```{r}
# Wir nehmen das beste Modell m1_1_4 und erstellen ein Residuenplot
ggplot(data = NULL, aes(x = m1_1_4_2_3$model$BusinessConfidence, y = m1_1_4_2_3$residuals)) + 
  geom_point() + 
  geom_smooth(se = FALSE, method = loess) + 
...
```{r}
# Wir nehmen das beste Modell m1_1_4 und erstellen ein Residuenplot
ggplot(data = NULL, aes(x = m1_1_4_2_3_5$model$Congestion, y = m1_1_4_2_3_5$residuals)) + 
  geom_point() + 
  geom_smooth(se = FALSE, method = loess) + 
