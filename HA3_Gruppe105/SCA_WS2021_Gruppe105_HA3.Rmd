...
```{r}
# TODO
# Wir nehmen zum einen das beste Modell m1_1_4_2_3 und nehmen das generelle Modell aus den cps_WH_externals Daten
# region (und Periode) muessen rein


# Da 202101 auf historische Januars basiert, filtern wir die alten Januars raus
cps_wh_externals = cps_wh_externals[cps_wh_externals$Month == "1",] 

# Modell erstellen fuer alle Regionen
